...
class BSeq:
    ...
    def calculate_balance(self):
        ...
        zeroes, ones = 0, 0
        for element in range(0, self.number):
            if element == 1:
                ones += 1
            else:
                zeroes += 1
    ...
    def __shift_sequence(self, sequence, index):
        try:
            ...
            print(f'{shift} - invalid shift value!')
            return "##ERROR##\n"
        else:
    ...
    def __create_prime_sequence(self):
        try:
            ...
            print(f'{self.number} - does not prime number!')
            return "##ERROR##\n"
        else:
...
# Создание ПСП
sequence_1 = BSeq(length, shifts, 3)

print(sequence_1.create_b_sequence())
